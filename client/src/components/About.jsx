    ...
    <section className="section about" id="about" ref={sectionRef}>
      <div className="container">
        <div className="section-header">
          ...
          <p className="section-subtitle">Here's a brief overview of who I am and what I do</p>
        </div>
        ...
        <div className={`about__grid ${isVisible ? 'about__grid--visible' : ''}`}>
            ...
            <div className="about__image-frame glass-card">
              <div className="about__image-placeholder">
                <span className="about__avatar-text">
                  {(profile?.name || 'AJ').split(' ').map(n => n[0]).join('')}
                </span>
              </div>
          ...
          <div className="about__content">
            <p className="about__bio">
              {profile?.bio || 'Passionate developer crafting modern web experiences.'}
            </p>

            <div className="about__stats">
              {(profile?.stats || []).map((stat, i) => (
                <div className="about__stat glass-card" key={i} style={{ animationDelay: `${i * 0.1}s` }}>
            ...
            <div className="about__socials">
              {(profile?.socials || []).map((social, i) => (
                <a
                  key={i}
                  href={social.url}
                  className="about__social glass-card"
                  target="_blank"
